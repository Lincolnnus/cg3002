...
<div id="system-message-container">
    ...
    <div class="wrapper_overflow">
	<p>1. Contact the System Admin to add you to the company database.</p>
	<p>2. If you are added as a System Admin, you can add/delete items, add/delete stores, add/delete employees, view store transaction/stock,add stock.
	   If you are added as a HQ Admin, you can view transactions of any store,add stock or view stocks of any store.
       If you are added as a local store manager, you can view your own store transaction and stocks.
       Item information is public to Everyone.</p>
    <p>3. If you are a local Store manager, you can download the software for your store's own use.
       The software is used for syncronizing price and transactions with HQ database.	</p>
	</div>
	</div>
          </div>
      </div>
