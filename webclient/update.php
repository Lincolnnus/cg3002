...
<div id="system-message-container">
	...
	if(isset($_REQUEST['i_id']))
	{
	   ...
	   {
	       echo ' <form name="updateitemForm">
		   <input type="hidden" name="i_id" value="'.$res['i_id'].'">
	  <table width="289" border="0">
		...
		<tr>
		  ...
		  <td><input type="text" name="productionDate" id="from" value="'.$res['productionDate'].'" placeholder="'.$res['productionDate'].'" ></td>
		</tr>
		<tr>
		  <td>Expire Date: </td>
		  <td><input type="text" name="expiryDate" id="till" value="'.$res['expiryDate'].'" placeholder="'.$res['expiryDate'].'"></td>
		</tr>
		<tr>
		  <td>Producer: </td>
		  <td><input type="text" name="producer" value="'.$res['producer'].'"></td>
		</tr>
		<tr>
		  <td>Supplier:</td>
		  <td><input type="text" name="supplier" value="'.$res['supplier'].'"></td>
		</tr>
		<tr>
			<td>Category: </td>
			<td><select name= "category">';
			$c_id=$res['c_id'];
			  $res=mysql_query("SELECT * from `category` where c_id=$c_id");
			  $res=mysql_fetch_array($res);
			  echo'<option value="'.$res['c_id'].'">'.$res['c_name'].'</option>';
			  $result=mysql_query("SELECT * from `category` where c_id=".$res['c_id']);
		...
		<tr>
		  ...
		  <td><button class="button" type="button"onClick="update_item();">Submit</button></td>
		</tr>
	  </table>
  </form>';
	   }
	}
	else {echo "Please Enter Item ID!";exit;}
	?>
	</div>
	</div>
          </div>
