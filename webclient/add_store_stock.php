...
<head>
  ...
  <title>home </title>
  <link href="/joomla_36885/templates/theme847/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
...
<script type="text/javascript">
				...
				$j(function()
				{
					...
					//preloadImages([
					//' /joomla_36885/templates/theme847/images/ .png']);
					});
					$j(document).ready(function() {				
...
<div class="slider-wrapper theme-default">
    <div id="vt_nivo_slider140" class="nivoSlider">
		<a href="/joomla_36885/" target="_self" style="background: none;"><img src="images/slider_pic1.jpg" alt="Vinaora Nivo Slider" title="" /></a>
<a href="/joomla_36885/" target="_self" style="background: none;"><img src="images/slider_pic2.jpg" alt="Vinaora Nivo Slider" title="" /></a>
<a href="/joomla_36885/" target="_self" style="background: none;"><img src="images/slider_pic3.jpg" alt="Vinaora Nivo Slider" title="" /></a>
<a href="/joomla_36885/" target="_self" style="background: none;"><img src="images/slider_pic4.jpg" alt="Vinaora Nivo Slider" title="" /></a>
<a href="/joomla_36885/" target="_self" style="background: none;"><img src="images/slider_pic5.jpg" alt="Vinaora Nivo Slider" title="" /></a>
    </div>
</div>
</div>
<script type="text/javascript">
...
<div id="system-message-container">
	...
	<h2>Add Store Stock</h2>
    <div class="wrapper_overflow">
<form name="addstockForm">
  <table width="289" border="0">
    <tr>
      <td width="124">Store ID: </td>
      <td width="149"><input type="text" name="s_id" placeholder="1"></td>
    </tr>
	<tr>
      <td width="124">Item ID: </td>
      <td width="149"><input type="text" name="i_id" placeholder="000001"></td>
    </tr>
	<tr>
      <td width="124">Quantity: </td>
      <td width="149"><input type="text" name="quantity" placeholder="40"></td>
    </tr>
		 <tr>
		  <td>Stock Ceiling: </td>
		  <td><input type="text" name="ceiling" placeholder="100"></td>
		</tr>
		<tr>
		  <td>Ceiling Variable:</td>
		  <td><input type="text" name="ceilingv"placeholder="0.5"></td>
		</tr>
		<tr>
		  <td>Stock Floor:</td>
		  <td><input type="text" name="floor" placeholder="20"></td>
		</tr>
		<tr>
		  <td>Floor Variable:</td>
		  <td><input type="text" name="floorv"placeholder="0.6"></td>
		</tr>
    <tr>
      <td><div id="err" style="color:#FF0000;visibility:hidden;">Show Errors</div></td>
      <td><button class="button" type="button"onClick="add_stock();">ADD</button></td>
    </tr>
  </table>
</form>
     <p>When the item stock is below the &quot;Stock Floor&quot; by X% in a store, the price of the item will be automatically increased by x%* &quot;Floor Variable&quot;. While when the item stock is above the &quot;Stock Ceiling&quot; by X% in a store, the price of the item will be automatically decreased by x%* &quot;Ceiling Variable&quot;.</p>
    </div>
	</div>
          </div>
      </div>
