...
<div id="system-message-container">
	...
	<h2>DELETE ITEM</h2>
    <div class="wrapper_overflow">
<form name="deleteitemForm">
  <table width="490" border="0">
    <tr>
      <td width="288">Enter the Barcode of the item you want to delete: </td>
      <td width="177"><input type="text" name="i_id"></td>
    </tr>
    <tr>
      <td><div id="err" style="color:#FF0000;visibility:hidden;">Show Errors</div></td>
      <td><button class="button" type="button"onClick="delete_item();">Submit</button></td>
    </tr>
  </table>
</form>
    </div>
