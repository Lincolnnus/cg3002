...
<head>
	...
	$(function() {
	 ...
	 jQuery( "#till" ).datepicker();
	 jQuery( "#till" ).datepicker( "option", "dateFormat", "yy-mm-dd" );
	 });
	</script>
    ...
    <title>home </title>
	 ...
	 function addCate()
	 {
		 ...
		 newcate.innerHTML='<input type="text" name="category" placeholder="add new category">';
	 }
	 </script>
...
<ul class="menu">
<li class="item-464 current active"><a class=" home_link" href="index.php" >home </a></li><li class="item-207 deeper parent"><a>Manage</a><?php
...
<a style="background: none;"><img src="images/slider_pic2.jpg" alt="Vinaora Nivo Slider" title="" /></a>
<a style="background: none;"><img src="images/slider_pic3.jpg" alt="Vinaora Nivo Slider" title="" /></a>
<a style="background: none;"><img src="images/slider_pic4.jpg" alt="Vinaora Nivo Slider" title="" /></a>
<a style="background: none;"><img src="images/slider_pic5.jpg" alt="Vinaora Nivo Slider" title="" /></a>
    </div>
</div>
</div>
<script type="text/javascript">
...
<div id="system-message-container">
    ...
    <form name="additemForm">
	  <table width="289" border="0">
		<tr>
		  <td width="124">Barcode: </td>
		  <td width="149"><input type="text" name="i_id" placeholder="012345"></td>
		</tr>
		<tr>
		  <td>Name:</td>
		  <td><input type="text" name="name" placeholder="LED"></td>
		</tr>
		<tr>
		  <td>Price:</td>
		  <td><input type="text" name="price" placeholder="10.00"></td>
		</tr>
		<tr>
		  <td>Production Date:</td>
		  <td><input type="text" name="productionDate" id="from" placeholder="2006-10-11"></td>
		</tr>
		<tr>
		  <td>Expire Date: </td>
		  <td><input type="text" name="expiryDate" id="till" placeholder="2013-10-11"></td>
		</tr>
		<tr>
		  <td>Producer: </td>
		  <td><input type="text" name="producer" placeholder="IBM"></td>
		</tr>
		<tr>
		  <td>Supplier:</td>
		  <td><input type="text" name="supplier" placeholder="NUS"></td>
		</tr>
		<tr>
			<td>Category: </td>
			<td id="newcate"><select name= "category">
			<?php  
		...
		<tr>
		    <td></td>
			<td><a href="add_category.php">Add New Category</a></td>
		</tr>
		<tr>
		  <td><div id="err" style="color:#FF0000;visibility:hidden;">Show Errors</div></td>
		  <td><button class="button" type="button"onClick="add_item();">Submit</button></td>
		</tr>
	  </table>
	 </form>
	</div>
