...
<head>
    <title> View Store Transaction</title>
...
<div id="system-message-container">
	...
	<h2>View Store Transaction</h2>
    <div class="wrapper_overflow">
	<form name="viewTranForm" method="post" action="view_trans.php">
	  <br>
	&nbsp;&nbsp;&nbsp;&nbsp;<br>
	...
	<table width="440" border="0">
	  <tr>
	    <td width="69">From</td>
	    <td width="149"><input type="text" id="from" name="from"></td>
	    <td width="20">To </td>
	    <td width="184"><input type="text" id="till" name="till" size="30"/></td>
	    </tr>
	  <tr>
	    <td>Store ID:</td>
	    <td><input type="text" name="s_id"></td>
	    <td>&nbsp;</td>
	    <td>&nbsp;<input class="button" type="submit" value="View Transaction"/></td>
	    </tr>
	  </table>
	&nbsp;&nbsp;
	</form>
