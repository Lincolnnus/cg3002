...
<script type="text/javascript">
       ...
       <![endif]-->
        <!--[if lt IE 9]>
        <style type="text/css">
         .readon, #header ul, #header ul ul li a,  .icon_block1 a, .icon_block2 a, .icon_block3 a, .project_block,  .readmore, .button, button, .product_block, #carousel li .p3, #map, .act_button { behavior:url(/joomla_36885/templates/theme847/PIE.php); position:relative; zoom:1 }
        </style>
        <![endif]-->
</head>
...
<div id="system-message-container">
  ...
  <table width="289" border="0">
    <tr>
      ...
      <td width="149"><input type="text" name="s_id"></td>
    </tr>
	<tr>
      <td width="124">Store Address: </td>
      <td width="149"><input type="text" name="address"></td>
    </tr>
    <tr>
      <td><div id="err" style="color:#FF0000;visibility:hidden;">Show Errors</div></td>
      <td><button class="button" type="button"onClick="add_store();">Submit</button></td>
    </tr>
  </table>
</form>
    </div>
