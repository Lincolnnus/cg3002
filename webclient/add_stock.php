...
<div id="system-message-container">
	...
	<h1>Search Item by</h1>
	<select name="criteria">
	<option value="i_id">Item ID(Barcode)</option>
	<option value="name">Item Name</option>
	<option value="producer">Producer</option>
	<option value="supplier">Supplier</option>
	</select>
	<input type="text" name="c_value" placeholder="please enter the value">
	<?php
	if ($_SESSION['role']=='Store Manager')
	{
	echo '<input type="hidden" name="s_id" value="'.$_SESSION['s_id'].'">';
	echo '<button  class="button" type="button"onClick="search_item_local();">Search</button>';
	}
	else echo '<button  class="button" type="button"onClick="search_item();">Search</button>';
	?>
	</form>
  ...
  <table width="289" border="0">
	...
	<tr>
      ...
      <td width="149"><input type="text" name="quantity" placeholder="30"></td>
    </tr>
	   <tr>
		  <td>Stock Ceiling: </td>
